                    ...
                    <div class="d-flex no-block justify-content-end align-items-center">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">التعليقات الصوتية</li>
                            </ol>
                        </nav>
                    </div>
                </div>
...
@section('script')
    ...
    @include('Admin.VoiceOver.script')
